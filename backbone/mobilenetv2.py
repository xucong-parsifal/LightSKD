...
class MobileNetV2(nn.Module):
    def __init__(
            self, num_classes=100, width_mult=1.0, inverted_residual_setting=None, round_nearest=8, block=None,
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                features.append(block(self.input_channel, output_channel, stride, expand_ratio=t, norm_layer=norm_layer))
